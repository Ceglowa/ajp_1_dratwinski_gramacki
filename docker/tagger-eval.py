...
def go():
	...
	for fold_idx in range(num_folds):
		...
		#ref_rdr = corpus2.TokenReader.create_path_reader(options.input_format, tagset, ref_fn)
                tag_rdr = corpus2.TokenReader.create_path_reader('ccl', tagset, tag_fn)  # tagged/predicted
                ref_rdr = corpus2.TokenReader.create_path_reader('xces', tagset, ref_fn)  # gold standard
